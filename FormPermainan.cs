...
namespace Tugas_Proyek
{
    public partial class FormPermainan : Form
    {
        ...
        private void FormPermainan_KeyDown(object sender, KeyEventArgs e)
        {
            if (turn)
            {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < b.Count; i++)
            {
                if (left[i] == head_x && top[i] == head_y)
                {
                    ...
                    try
                    {
                        connStr = "INSERT INTO skor(id,nama,score,kesulitan,tanggal) VALUES( " + data.ToString() + ",'" + akhir + "'," + score.ToString() + ",0,GETDATE())";
            ...
            else
            {
                ...
                if (head_x < 0)
                {
                    head_x = this.Width + head_x - 30;
                }
                else if (head_y < 0)
                {
                    head_y = this.Height + head_y - 30;
                }
                else if (head_x + 30 > this.Width)
                {
                    int temp = head_x + 30;
                    head_x = temp - this.Width - 30;
                }
                else if (head_y + 30 > this.Height)
                {
                    int temp = head_y + 30;
                    head_y = temp - this.Height - 30;
                }
            }
            if (left[0] > tail_x)
            {
            ...
            if (blink <= 50)//ubah angka kalau timer2 ticknya ditambah
            {
                if (blink >= 35)
                {
                    idxapple++;
        ...
        private void FormPermainan_Paint(object sender, PaintEventArgs e)
        {
            g = e.Graphics;
            if (left[0] < tail_x)
            {
